...
public class DESProductVariantService {
	...
	@RequestMapping(value = "/gescatalogoListarAllByParent", method = {RequestMethod.POST})
	@JpoClass(oauth2Enable = true)
	public Object gescatalogoListarAllByParent(Jpo ppo, HttpServletRequest request) throws Exception {
		Procedure pResult = ppo.procedure("ges.catalogo_listar_all_by_parent","DES");
		pResult.input("catalogo_id", Jpo.INTEGER);
		Object ohb_response = pResult.executeL();
		ppo.commit();
		return new Response(ohb_response);
	}
